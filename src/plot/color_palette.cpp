...
auto color_palette::get_color_string() -> std::string const&
{
...
void color_palette::unget_color_string(std::string const& colour_value)
{
    m_colors.erase(get_iterator_from_string(colour_value));
    m_colors.insert(m_colors.begin() + m_counter, colour_value);
}

auto color_palette::get_iterator_from_string(std::string const& colour_value)
