...
void speaker_editor::on_selection_changed()
{
    ...
    if (const Gtk::TreeIter iter = selection->get_selected())
    {
        ...
        {
            index = path[0];
            Speaker const& speaker = m_speaker_list->data()[index];
...
void speaker_editor::draw_impedance_plot(Speaker const& s, bool update)
{
    ...
    if (g_settings.getValueBool("DrawDriverImpPlot"))
    {
        ...
        if (of.good())
        {
            of << "SPICE code generated by gspk Redux-" << VERSION << "\n";
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.qts], 3, 3);
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.fs], 3, 0) + " Hz";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.vas], 3, 3) + " l";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.rdc], 3, 1) + " Ohm";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.lvc], 3, 2) + " mH";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.qms], 3, 3);
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.qes], 3, 2);
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.imp], 3, 1) + " Ohm";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.sens], 3, 1) + " dB";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.mmd] * 1000, 3, 2)
                               + " g";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.ad], 3, 3) + " m";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.bl], 3, 1) + " N/A";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.rms], 3, 2) + " Ns/m";
    renderer.property_xalign() = 1.0;
}
...
{
    auto& renderer = dynamic_cast<Gtk::CellRendererText&>(*cell);
    renderer.property_text() = gspk::double_to_ustring((*iter)[m_columns.cms], 3, 4) + " m/N";
    renderer.property_xalign() = 1.0;
}
