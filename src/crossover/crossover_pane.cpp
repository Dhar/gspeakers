...
crossover_pane::crossover_pane()
{
    ...
    m_plot_notebook.append_page(m_filter_plot, _("Crossover freq resp"));
    m_plot_notebook.append_page(m_total_filter_plot, _("Total crossover freq resp"));
    m_plot_notebook.append_page(m_summed_freq_resp_plot, _("Total freq resp"));
